<?php
/**
 * WP Bootstrap Navwalker   *-* 02Dez24 Angepasster WP_Bootstrap_Navwalker, um die Drop-down-Pfeile zu entfernen: der original navwalker-code wurde geändert: aus der Z.218 $atts['class'] = 'dropdown-toggle nav-link'; wurde die Klasse .dropdown-toggle entfernt *-*
 *
